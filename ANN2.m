...
%%direct training with test examples
...
k=rand(1,n);
[M,N]=sort(k);
testdIn=In(:,N(:));%%pick out input and output for testing
testdOut=Out(N(:));

%training data normalization
[train_inN,tranin_inS]=mapminmax(data(2:6,:));
[train_outN,train_outS]=mapminmax(data(1,:));
